    ...
    <div class="row">
        <table class="table table-striped" style="margin-top: 40px;">
            ...
            <c:forEach var="remorca" items="${requestScope.TrailsTobeDisplayed}">
                <tr>
                    <th>${remorca.idRemorca}</th>
                    <td>${remorca.anulFabricatiei}</td>
                    <td>${remorca.itp}</td>

                    <td>

                        <a href="?action=editRemorca&id=${remorca.idRemorca} "data-toggle="tooltip" title="Editeaza" style="color: rgba(0, 0, 0, 0.54); "><span class="material-icons">edit</span> </a>
                        <a href="?action=deleteRemorca&id=${remorca.idRemorca} "data-toggle="tooltip" title="Sterge" style="color: rgba(0, 0, 0, 0.54); "><span class="material-icons">delete</span></a>
                        <!--<a href="?action=delete&id=${remorca.idRemorca}">
